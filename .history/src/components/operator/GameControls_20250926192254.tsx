...
export default function GameControls({ gameState, onError, onQuestionUsed }: GameControlsProps) {
  ...
  const handleResetEverything = async () => {
    ...
    try {
      ...
      // Step 2: Delete all questions from Firebase
      try {
        // Clear the main questions document by setting empty data
        ...
        onError('Failed to clear all questions');
      }
      ...
      onError('Failed to reset everything');
    } finally {
      setProcessing(false);
    }
  };
